# Generated by Django 4.2.7 on 2024-09-24 22:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='ФИО')),
                ('school', models.CharField(blank=True, max_length=100, null=True, verbose_name='Maktab')),
                ('class_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='klass')),
                ('city', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tuman')),
                ('parent_number', models.CharField(blank=True, max_length=100, null=True, verbose_name='Telefon rakami')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('telegram_id', models.BigIntegerField(blank=True, null=True, verbose_name='Telegram ID')),
                ('teacher_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='ФИО')),
                ('school', models.CharField(blank=True, max_length=100, null=True, verbose_name='Maktab')),
                ('class_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='klass')),
                ('city', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tuman')),
                ('teacher_number', models.CharField(blank=True, max_length=100, null=True, verbose_name='Telefon rakami')),
                ('payment', models.BooleanField(blank=True, default=False, null=True, verbose_name='Tolov')),
                ('language', models.CharField(blank=True, max_length=5, null=True, verbose_name='Til')),
            ],
        ),
