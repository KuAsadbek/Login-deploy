# Generated by Django 4.2.7 on 2024-09-23 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('telegram_id', models.BigIntegerField(blank=True, null=True, verbose_name='Telegram ID')),
                ('who', models.CharField(blank=True, max_length=5, null=True, verbose_name='Qaysi foydalanuvchi')),
                ('full_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='ФИО')),
                ('school', models.CharField(blank=True, max_length=100, null=True, verbose_name='Maktab')),
                ('class_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='klass')),
                ('city', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tuman')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='main_app.parentmod', verbose_name='Parents')),
                ('teacher', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='main_app.teachermod', verbose_name='Teachers')),
            ],
            options={
                'verbose_name': 'User',
